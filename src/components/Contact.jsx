...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(import.meta.env.VITE_APP_EMAILJS_SERVICE_ID, import.meta.env.VITE_APP_EMAILJS_TEMPLATE_ID, {
      ...
      to_email: 'bagassahadewa2@gmail.com',
      message: form.message
    }, import.meta.env.VITE_APP_EMAILJS_PUBLIC_KEY).then((result) => {
      setLoading(false)
      alert('Terima kasih. saya akan membalas email anda secepatnya.')
      setForm({
        name: '',
        email: '',
        message: ''
    ...
    <div className="xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden">
      <motion.div variants={slideIn('left', "tween", 0.2, 1)} className="flex-[0.75] bg-black-100 p-8 rounded-2xl">
        ...
        <form ref={formRef} onSubmit={handleSubmit} className="mt-12 flex flex-col gap-8">
          ...
          <button type="submit" className="bg-tertiary hover:bg-tertiary/70 py-3 px-8 outline-none w-fit text-white font-bold shadow-md shadow-primary rounded-xl cursor-pointer">
